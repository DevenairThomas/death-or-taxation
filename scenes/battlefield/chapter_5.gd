...
func preperation_mode():
	# Turn on prep
	BattlefieldInfo.preparation_screen.start(Callable(chapter_title, BattlefieldInfo.victory_text).bind("res://scenes/intro_screen/Intro Screen.tscn"), prep_music_choice)
